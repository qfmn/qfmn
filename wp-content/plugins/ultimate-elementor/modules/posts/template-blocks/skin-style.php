...
abstract class Skin_Style {
	...
	public function render_pagination() {
		...
		if ( $total_pages > 1 ) {
			...
			?>
			<nav class="uael-grid-pagination" <?php echo wp_kses_post( $class ); ?> role="navigation" aria-label="<?php esc_attr_e( 'Pagination', 'uael' ); ?>" data-total="<?php echo esc_attr( $total_pages ); ?>">
