...
function hero_load_this_config(){var csshero_promise=jQuery.Deferred();window.csshero_theme_is_configurated=false;var frame=window.frames['csshero-iframe-main-page'].document.body;var generic_inner_stuff=[{des:'Heading',sel:'.elementor-heading-title'},{sel:'.elementor-image img',des:'Image'},{sel:'.elementor-button-wrapper .elementor-button',des:'Button'},{sel:'.elementor-divider .elementor-divider-separator',des:'Separator'},{sel:'.elementor-icon i',des:'Icon'},{sel:'.elementor-widget-container',des:'Widget Container'},{sel:'.elementor-column-wrap .elementor-column-wrap',des:'Column'},{sel:'.elementor-widget-wrap',des:'Widget Wrap'},{sel:'.elementor-image-box-wrapper',des:'Image Box Wrapper'},{sel:'.elementor-image-box-wrapper .elementor-image-box-img img',des:'Image Box Img'},{sel:'.elementor-image-box-wrapper .elementor-image-box-content',des:'Image Box Content'},{sel:'.elementor-image-box-wrapper .elementor-image-box-title',des:'Image Box Title'},{sel:'.elementor-image-box-wrapper .elementor-image-box-title a',des:'Image Box Title Link'},{sel:'.elementor-image-box-wrapper .elementor-image-box-description',des:'Image Box Description'},{sel:'.elementor-image-box-wrapper .elementor-image-box-description a',des:'Image Box Description Link'},{sel:'.elementor-widget-icon-box .elementor-widget-container',des:'Icon Box Wrapper'},{sel:'.elementor-widget-icon-box .elementor-icon-box-icon .elementor-icon',des:'Icon Wrapper'},{sel:'.elementor-widget-icon-box .elementor-icon-box-icon i',des:'Icon Box Icon'},{sel:'.elementor-widget-icon-box .elementor-icon-box-content',des:'Icon Box Content'},{sel:'.elementor-widget-icon-box .elementor-icon-box-title',des:'Icon Box Title'},{sel:'.elementor-widget-icon-box .elementor-icon-box-title span',des:'Icon Box Title Span'},{sel:'.elementor-widget-icon-box .elementor-icon-box-title a',des:'Icon Box Title Link'},{sel:'.elementor-widget-icon-box .elementor-icon-box-description',des:'Icon Box Description'},{sel:'.elementor-widget-icon-box .elementor-icon-box-description a',des:'Icon Box Description Link'},{sel:'.elementor-icon-box-wrapper',des:'Icon Box Wrapper'},{sel:'.elementor-icon-box-wrapper .elementor-icon-box-icon i',des:'Icon Box Icon'},{sel:'.elementor-icon-box-wrapper .elementor-icon-box-icon .elementor-icon',des:'Icon Wrapper'},{sel:'.elementor-icon-box-wrapper .elementor-icon-box-content',des:'Icon Box Content'},{sel:'.elementor-icon-box-wrapper .elementor-icon-box-title',des:'Icon Box Title'},{sel:'.elementor-icon-box-wrapper .elementor-icon-box-title span',des:'Icon Box Title Span'},{sel:'.elementor-icon-box-wrapper .elementor-icon-box-title a',des:'Icon Box Title Link'},{sel:'.elementor-icon-box-wrapper .elementor-icon-box-description',des:'Icon Box Description'},{sel:'.elementor-icon-box-wrapper .elementor-icon-box-description a',des:'Icon Box Description Link'},{sel:'.elementor-image-gallery',des:'Gallery'},{sel:'.elementor-image-gallery img',des:'Gallery Img'},{sel:'.elementor-image-gallery .gallery-item',des:'Gallery Item'},{sel:'.elementor-image-gallery .wp-caption-text',des:'Gallery Caption'},{sel:'.elementor-image-carousel',des:'Carousel'},{sel:'.elementor-image-carousel > button',des:'Carousel Button'},{sel:'.elementor-image-carousel img',des:'Carousel Img'},{sel:'.elementor-image-carousel .slick-dots',des:'Carousel Pagination Area'},{sel:'.elementor-image-carousel .slick-dots li > button',des:'Carousel Pagination Item'},{sel:'.elementor-icon-list-items',des:'List Area'},{sel:'.elementor-icon-list-items .elementor-icon-list-icon i',des:'List Text'},{sel:'.elementor-icon-list-items .elementor-icon-list-text',des:'List Text'},{sel:'.elementor-counter .elementor-counter-number',des:'Number'},{sel:'.elementor-counter .elementor-counter-title',des:'Number Title'},{sel:'.elementor-counter .elementor-counter-number-prefix',des:'Number Prefix'},{sel:'.elementor-counter .elementor-counter-number-suffix',des:'Number Suffix'},{sel:'.elementor-widget-progress',des:'Progress Area'},{sel:'.elementor-widget-progress .elementor-title',des:'Progress Bar Title'},{sel:'.elementor-widget-progress .elementor-progress-bar',des:'Progress Bar'},{sel:'.elementor-widget-progress .elementor-progress-text',des:'Progress Bar Text'},{sel:'.elementor-widget-progress .elementor-progress-percentage',des:'Progress Bar Percentage'},{sel:'.elementor-widget-progress .elementor-progress-wrapper',des:'Progress Bar Wrapper'},{sel:'.elementor-widget-testimonial',des:'Testimonial'},{sel:'.elementor-widget-testimonial .elementor-testimonial-content',des:'Testimonial Content'},{sel:'.elementor-widget-testimonial .elementor-testimonial-meta',des:'Testimonial Meta Area'},{sel:'.elementor-widget-testimonial .elementor-testimonial-image',des:'Testimonial Img Area'},{sel:'.elementor-widget-testimonial .elementor-testimonial-image',des:'Testimonial Img'},{sel:'.elementor-widget-testimonial .elementor-testimonial-details',des:'Testimonial Details'},{sel:'.elementor-widget-testimonial .elementor-testimonial-details .elementor-testimonial-name',des:'Testimonial Name'},{sel:'.elementor-widget-testimonial .elementor-testimonial-details .elementor-testimonial-job',des:'Testimonial Job'},{sel:'.elementor-widget-tabs',des:'Tabs'},{sel:'.elementor-widget-tabs .elementor-tabs-wrapper',des:'Tabs Head'},{sel:'.elementor-widget-tabs .elementor-tabs-wrapper .elementor-tab-title',des:'Tabs Tab'},{sel:'.elementor-widget-tabs .elementor-tabs-wrapper .elementor-tab-title.elementor-active',des:'Tabs Tab Active'},{sel:'.elementor-widget-tabs .elementor-tab-content',des:'Tabs Content'},{sel:'.elementor-widget-tabs .elementor-tab-content a',des:'Tabs Content Links'},{sel:'.elementor-accordion',des:'Accordion'},{sel:'.elementor-accordion .elementor-accordion-item',des:'Accordion Item'},{sel:'.elementor-accordion .elementor-tab-title',des:'Accordion Tab Title'},{sel:'.elementor-accordion .elementor-tab-title .elementor-accordion-icon i',des:'Accordion Tab Title Icon'},{sel:'.elementor-accordion .elementor-tab-title.elementor-active',des:'Accordion Tab Title Active'},{sel:'.elementor-accordion .elementor-tab-title.elementor-active .elementor-accordion-icon i',des:'Accordion Tab Title Active Icon'},{sel:'.elementor-accordion .elementor-tab-content',des:'Accordion Content'},{sel:'.elementor-accordion .elementor-tab-content a',des:'Accordion Content Link'},{sel:'.elementor-toggle',des:'Toggle'},{sel:'.elementor-toggle .elementor-tab-title',des:'Toggle Title'},{sel:'.elementor-toggle .elementor-tab-title i',des:'Toggle Title Icon'},{sel:'.elementor-toggle .elementor-tab-content',des:'Toggle Content'},{sel:'.elementor-toggle .elementor-tab-content a',des:'Toggle Content Link'},{sel:'.elementor-widget-social-icons',des:'Socials Wrapper'},{sel:'.elementor-widget-social-icons a',des:'Socials Item'},{sel:'.elementor-alert.elementor-alert-info',des:'Alert Info'},{sel:'.elementor-alert.elementor-alert-info .elementor-alert-title',des:'Alert Info Title'},{sel:'.elementor-alert.elementor-alert-info .elementor-alert-description',des:'Alert Info Contents'},{sel:'.elementor-alert.elementor-alert-info .elementor-alert-dismiss',des:'Alert Info Dismiss'},{sel:'.elementor-alert.elementor-alert-success',des:'Alert success'},{sel:'.elementor-alert.elementor-alert-success .elementor-alert-title',des:'Alert success Title'},{sel:'.elementor-alert.elementor-alert-success .elementor-alert-description',des:'Alert success Contents'},{sel:'.elementor-alert.elementor-alert-success .elementor-alert-dismiss',des:'Alert success Dismiss'},{sel:'.elementor-alert.elementor-alert-warning',des:'Alert warning'},{sel:'.elementor-alert.elementor-alert-warning .elementor-alert-title',des:'Alert warning Title'},{sel:'.elementor-alert.elementor-alert-warning .elementor-alert-description',des:'Alert warning Contents'},{sel:'.elementor-alert.elementor-alert-warning .elementor-alert-dismiss',des:'Alert warning Dismiss'},{sel:'.elementor-alert.elementor-alert-danger',des:'Alert danger'},{sel:'.elementor-alert.elementor-alert-danger .elementor-alert-title',des:'Alert danger Title'},{sel:'.elementor-alert.elementor-alert-danger .elementor-alert-description',des:'Alert danger Contents'},{sel:'.elementor-alert.elementor-alert-danger .elementor-alert-dismiss',des:'Alert danger Dismiss'},{sel:'.elementor-widget-posts ',des:'Posts Area'},{sel:'.elementor-widget-posts .elementor-post',des:'Post'},{sel:'.elementor-widget-posts .elementor-post__thumbnail img',des:'Post Img'},{sel:'.elementor-widget-posts .elementor-post__text',des:'Posts Text Area'},{sel:'.elementor-widget-posts .elementor-post__title a',des:'Post Title Link'},{sel:'.elementor-widget-posts .elementor-post__meta-data',des:'Post Meta Area'},{sel:'.elementor-widget-posts .elementor-post__meta-data span',des:'Post Meta Item'},{sel:'.elementor-widget-posts .elementor-post__excerpt',des:'Post Excerpt p'},{sel:'.elementor-widget-posts .elementor-post__read-more',des:'Post Read More'},{sel:'.elementor-widget-posts .elementor-post__meta-data .elementor-post-date',des:'Post Meta Date'},{sel:'.elementor-widget-posts .elementor-post__meta-data .elementor-post-avatar',des:'Post Avatar'},{sel:'.elementor-widget-posts .elementor-post__avatar',des:'Post Avatar'},{sel:'.elementor-widget-posts .elementor-post__avatar img',des:'Post Avatar Img'},{sel:'.elementor-widget-posts .elementor-post__card',des:'Post Card'},{sel:'.elementor-widget-posts .elementor-post__badge',des:'Post Badge'},{sel:'.elementor-widget-posts .elementor-post__thumbnail__link',des:'Post Thumbnail Link'},{sel:'.elementor-posts-container ',des:'Posts Area'},{sel:'.elementor-posts-container .elementor-post',des:'Post'},{sel:'.elementor-posts-container .elementor-post__thumbnail img',des:'Post Img'},{sel:'.elementor-posts-container .elementor-post__text',des:'Posts Text Area'},{sel:'.elementor-posts-container .elementor-post__title a',des:'Post Title Link'},{sel:'.elementor-posts-container .elementor-post__meta-data',des:'Post Meta Area'},{sel:'.elementor-posts-container .elementor-post__meta-data span',des:'Post Meta Item'},{sel:'.elementor-posts-container .elementor-post__excerpt',des:'Post Excerpt'},{sel:'.elementor-posts-container .elementor-post__excerpt p',des:'Post Excerpt Paragraph'},{sel:'.elementor-posts-container .elementor-post__read-more',des:'Post Read More'},{sel:'.elementor-posts-container .elementor-post__meta-data .elementor-post-date',des:'Post Meta Date'},{sel:'.elementor-posts-container .elementor-post__meta-data .elementor-post-avatar',des:'Post Avatar'},{sel:'.elementor-posts-container .elementor-post__avatar',des:'Post Avatar'},{sel:'.elementor-posts-container .elementor-post__avatar img',des:'Post Avatar Img'},{sel:'.elementor-posts-container .elementor-post__card',des:'Post Card'},{sel:'.elementor-posts-container .elementor-post__badge',des:'Post Badge'},{sel:'.elementor-posts-container .elementor-post__thumbnail__link',des:'Post Thumbnail Link'},{sel:'.elementor-portfolio',des:'Portfolio Area'},{sel:'.elementor-portfolio .elementor-portfolio-item',des:'Portfolio Item'},{sel:'.elementor-portfolio .elementor-portfolio-item .elementor-portfolio-item__overlay',des:'Portfolio Overlay'},{sel:'.elementor-portfolio .elementor-portfolio-item .elementor-portfolio-item__title',des:'Portfolio Overlay Title'},{sel:'.elementor-widget-slides',des:'Slides'},{sel:'.elementor-widget-slides .slick-arrow',des:'Slides Arrows'},{sel:'.elementor-widget-slides .elementor-slide-content',des:'Slide Content'},{sel:'.elementor-widget-slides .elementor-slide-content .elementor-slide-heading',des:'Slide Heading'},{sel:'.elementor-widget-slides .elementor-slide-content .elementor-slide-description',des:'Slide Content'},{sel:'.elementor-widget-slides .elementor-slide-content .elementor-slide-button',des:'Slide Button'},{sel:'.elementor-widget-slides .slick-dots',des:'Slides Nav'},{sel:'.elementor-widget-slides .slick-dots li',des:'Slides Nav Item'},{sel:'.elementor-widget-slides.slick-dots li button',des:'Slides Nav Dot'},{sel:'.elementor-form',des:'Form Area'},{sel:'.elementor-form .elementor-field-group',des:'Form Group'},{sel:'.elementor-form label',des:'Form Label'},{sel:'.elementor-form input',des:'Form Input Field'},{sel:'.elementor-form textarea',des:'Form Textarea'},{sel:'.elementor-form button[type=submit]',des:'Form Button'},{sel:'.elementor-widget-nav-menu',des:'Nav Area'},{sel:'.elementor-widget-nav-menu .elementor-menu-toggle',des:'Nav Toggle'},{sel:'.elementor-widget-nav-menu .elementor-menu-toggle i',des:'Nav Toggle Icon'},{sel:'.elementor-widget-nav-menu .elementor-nav-menu',des:'Nav Menu Wrapper'},{sel:'.elementor-widget-nav-menu .elementor-nav-menu li a',des:'Nav Menu Item'},{sel:'.elementor-headline',des:'Headline Area'},{sel:'.elementor-headline .elementor-headline-plain-text',des:'Headline Plain Text'},{sel:'.elementor-headline .elementor-headline-dynamic-text',des:'Headline Dynamic Text'},{sel:'.elementor-widget-price-list',des:'Prices Area'},{sel:'.elementor-widget-price-list ul.elementor-price-list',des:'Prices List'},{sel:'.elementor-widget-price-list ul.elementor-price-list li',des:'Prices List Item'},{sel:'.elementor-widget-price-list li .elementor-price-list-header',des:'Prices Header'},{sel:'.elementor-widget-price-list li .elementor-price-list-title',des:'Prices Title'},{sel:'.elementor-widget-price-list li .elementor-price-list-separator',des:'Prices Separator'},{sel:'.elementor-widget-price-list li .elementor-price-list-price',des:'Prices Price'},{sel:'.elementor-widget-price-list li .elementor-price-list-description',des:'Prices Description'},{sel:'.elementor-widget-price-list li .elementor-price-list-description a',des:'Prices Description Link'},{sel:'.elementor-widget-price-table',des:'Pricing Area'},{sel:'.elementor-widget-price-table .elementor-widget-container',des:'Pricing Container'},{sel:'.elementor-widget-price-table .elementor-price-table__header',des:'Pricing Header'},{sel:'.elementor-widget-price-table .elementor-price-table__header .elementor-price-table__heading',des:'Pricing Heading'},{sel:'.elementor-widget-price-table .elementor-price-table__header.elementor-price-table__subheading',des:'Pricing Description'},{sel:'.elementor-widget-price-table .elementor-price-table__ribbon-inner',des:'Pricing Ribbon'},{sel:'.elementor-widget-price-table .elementor-price-table__price',des:'Pricing Price'},{sel:'.elementor-widget-price-table .elementor-price-table__price .elementor-price-table__original-price',des:'Pricing Original'},{sel:'.elementor-widget-price-table .elementor-price-table__price .elementor-price-table__currency',des:'Pricing Currency'},{sel:'.elementor-widget-price-table .elementor-price-table__price .elementor-price-table__integer-part',des:'Pricing Integer'},{sel:'.elementor-widget-price-table .elementor-price-table__price .elementor-price-table__fractional-part',des:'Pricing Fractional'},{sel:'.elementor-widget-price-table .elementor-price-table__price .elementor-price-table__period',des:'Pricing Period'},{sel:'.elementor-widget-price-table .elementor-price-table__features-list',des:'Pricing Features'},{sel:'.elementor-widget-price-table .elementor-price-table__features-list li',des:'Pricing Feature'},{sel:'.elementor-widget-price-table .elementor-price-table__features-list li i',des:'Pricing Feature Icon'},{sel:'.elementor-widget-price-table .elementor-price-table__button',des:'Pricing Button'},{sel:'.elementor-widget-price-table .elementor-price-table__additional_info',des:'Pricing Info'},{sel:'.elementor-widget-price-table .elementor-price-table__additional_info p',des:'Pricing Info Paragraph'},{sel:'.elementor-widget-price-table .elementor-price-table__additional_info a',des:'Pricing Info Link'},{sel:'.elementor-flip-box .elementor-flip-box__front',des:'Flip Front Layer'},{sel:'.elementor-flip-box .elementor-flip-box__front .elementor-flip-box__layer__title',des:'Flip Front Title'},{sel:'.elementor-flip-box .elementor-flip-box__front .elementor-icon-wrapper',des:'Flip Front Icon Wrapper'},{sel:'.elementor-flip-box .elementor-flip-box__front .elementor-icon-wrapper i',des:'Flip Front Icon'},{sel:'.elementor-flip-box .elementor-flip-box__front .elementor-flip-box__layer__description',des:'Flip Front Description'},{sel:'.elementor-flip-box .elementor-flip-box__front .elementor-flip-box__layer__description p',des:'Flip Front Description Paragraph'},{sel:'.elementor-flip-box .elementor-flip-box__front .elementor-flip-box__layer__description a',des:'Flip Front Description Link'},{sel:'.elementor-flip-box .elementor-flip-box__front .elementor-flip-box__button',des:'Flip Front Button'},{sel:'.elementor-flip-box .elementor-flip-box__back',des:'Flip back Layer'},{sel:'.elementor-flip-box .elementor-flip-box__back .elementor-flip-box__layer__title',des:'Flip back Title'},{sel:'.elementor-flip-box .elementor-flip-box__back .elementor-icon-wrapper',des:'Flip back Icon Wrapper'},{sel:'.elementor-flip-box .elementor-flip-box__back .elementor-icon-wrapper i',des:'Flip back Icon'},{sel:'.elementor-flip-box .elementor-flip-box__back .elementor-flip-box__layer__description',des:'Flip back Description'},{sel:'.elementor-flip-box .elementor-flip-box__back .elementor-flip-box__layer__description p',des:'Flip back Description Paragraph'},{sel:'.elementor-flip-box .elementor-flip-box__back .elementor-flip-box__layer__description a',des:'Flip back Description Link'},{sel:'.elementor-flip-box .elementor-flip-box__back .elementor-flip-box__button',des:'Flip back Button'},{sel:'.elementor-widget-call-to-action',des:'CTA Area'},{sel:'.elementor-widget-call-to-action .elementor-cta__bg-overlay',des:'CTA Overlay'},{sel:'.elementor-widget-call-to-action .elementor-cta__content',des:'CTA Content'},{sel:'.elementor-widget-call-to-action .elementor-cta__content .elementor-cta__title',des:'CTA Title'},{sel:'.elementor-widget-call-to-action .elementor-cta__content .elementor-cta__description',des:'CTA Description'},{sel:'.elementor-widget-call-to-action .elementor-cta__content .elementor-cta__description p',des:'CTA Description Paragraph'},{sel:'.elementor-widget-call-to-action .elementor-cta__content .elementor-cta__description a',des:'CTA Description Link'},{sel:'.elementor-widget-call-to-action .elementor-cta__button',des:'CTA Button'},{sel:'.elementor-widget-testimonial-carousel .elementor-testimonial',des:'Testimonial Area'},{sel:'.elementor-widget-testimonial-carousel .elementor-testimonial__text',des:'Testimonial Text'},{sel:'.elementor-widget-testimonial-carousel .elementor-testimonial__footer',des:'Testimonial Footer'},{sel:'.elementor-widget-testimonial-carousel .elementor-testimonial__footer .elementor-testimonial__image img',des:'Testimonial Image'},{sel:'.elementor-widget-testimonial-carousel .elementor-testimonial__footer .elementor-testimonial__cite',des:'Testimonial Author Area'},{sel:'.elementor-widget-testimonial-carousel .elementor-testimonial__footer .elementor-testimonial__name',des:'Testimonial Name'},{sel:'.elementor-widget-testimonial-carousel .elementor-testimonial__footer .elementor-testimonial__title',des:'Testimonial Title'},{sel:'.elementor-widget-testimonial-carousel .swiper-pagination',des:'Testimonial Pagination Area'},{sel:'.elementor-widget-testimonial-carousel .swiper-pagination .swiper-pagination-bullet',des:'Testimonial Pagination Bullet'},{sel:'.elementor-widget-testimonial-carousel .swiper-pagination .swiper-pagination-bullet.swiper-pagination-bullet-active',des:'Testimonial Pagination Active Bullet'},{sel:'.elementor-widget-countdown',des:'Countdown Area'},{sel:'.elementor-widget-countdown .elementor-countdown-item',des:'Countdown Item'},{sel:'.elementor-widget-countdown .elementor-countdown-item .elementor-countdown-digits',des:'Countdown Digit'},{sel:'.elementor-widget-countdown .elementor-countdown-item .elementor-countdown-label',des:'Countdown Label'},{sel:'.elementor-widget-blockquote',des:'Blockquote Area'},{sel:'.elementor-widget-blockquote .elementor-blockquote',des:'Blockquote Quote'},{sel:'.elementor-widget-blockquote .elementor-blockquote p',des:'Blockquote Quote Paragraph'},{sel:'.elementor-widget-blockquote .elementor-blockquote a',des:'Blockquote Quote Link'},{sel:'.elementor-widget-blockquote footer',des:'Blockquote Footer'},{sel:'.elementor-widget-blockquote .elementor-blockquote__author',des:'Blockquote Author'},{sel:'.elementor-widget-blockquote .elementor-blockquote__tweet-button',des:'Blockquote Tweet Button'},{sel:'.elementor-widget-obfx-pricing-table',des:'Pricing Area'},{sel:'.elementor-widget-obfx-pricing-table .obfx-pricing-table-wrapper',des:'Pricing Table'},{sel:'.elementor-widget-obfx-pricing-table .obfx-title-wrapper',des:'Pricing Title Area'},{sel:'.elementor-widget-obfx-pricing-table .obfx-title-wrapper .obfx-pricing-table-title',des:'Pricing Table Title'},{sel:'.elementor-widget-obfx-pricing-table .obfx-title-wrapper .obfx-pricing-table-subtitle',des:'Pricing Table Subtitle'},{sel:'.elementor-widget-obfx-pricing-table .obfx-price-wrapper',des:'Price Wrapper'},{sel:'.elementor-widget-obfx-pricing-table .obfx-price-wrapper .obfx-price-currency',des:'Price Currency'},{sel:'.elementor-widget-obfx-pricing-table .obfx-price-wrapper .obfx-price',des:'Table Price'},{sel:'.elementor-widget-obfx-pricing-table .obfx-price-wrapper .obfx-pricing-period',des:'Pricing Period'},{sel:'.elementor-widget-obfx-pricing-table .obfx-feature-list',des:'Pricing Feature List'},{sel:'.elementor-widget-obfx-pricing-table .obfx-feature-list li',des:'Pricing Feature'},{sel:'.elementor-widget-obfx-pricing-table .obfx-feature-list li i',des:'Pricing Feature Icon'},{sel:'.elementor-widget-obfx-pricing-table .obfx-feature-list li a',des:'Pricing Feature Link'},{sel:'.elementor-widget-obfx-pricing-table .obfx-feature-list li .obfx-pricing-table-accented',des:'Pricing Feature Accent'},{sel:'.elementor-widget-obfx-pricing-table .obfx-feature-list li .obfx-pricing-table-feature',des:'Pricing Feature Text'},{sel:'.elementor-widget-obfx-pricing-table .obfx-pricing-table-button-wrapper',des:'Pricing Button Area'},{sel:'.elementor-widget-obfx-pricing-table .obfx-pricing-table-button-wrapper .obfx-pricing-table-button',des:'Pricing Button'},{sel:'.elementor-widget-obfx-services',des:'Services Area'},{sel:'.elementor-widget-obfx-services .obfx-grid-wrapper',des:'Services Item'},{sel:'.elementor-widget-obfx-services .obfx-icon-wrap i',des:'Services Icon'},{sel:'.elementor-widget-obfx-services .obfx-service-box-content',des:'Services Content'},{sel:'.elementor-widget-obfx-services .obfx-service-box-content .obfx-service-title',des:'Services Title'},{sel:'.elementor-widget-obfx-services .obfx-service-box-content .obfx-service-text',des:'Services Text'},{sel:'.elementor-widget-obfx-services .obfx-service-box-content .obfx-service-text p',des:'Services Paragraph'},{sel:'.elementor-widget-obfx-services .obfx-service-box-content .obfx-service-text a',des:'Services Link'},{sel:'.elementor-widget-obfx-posts-grid',des:'Posts Grid Area'},{sel:'.elementor-widget-obfx-posts-grid .obfx-grid-wrapper',des:'Posts Grid Item'},{sel:'.elementor-widget-obfx-posts-grid .obfx-grid-col-image',des:'Posts Grid Image Area'},{sel:'.elementor-widget-obfx-posts-grid .obfx-grid-col-image img',des:'Posts Grid Image'},{sel:'.elementor-widget-obfx-posts-grid .obfx-grid-col-content',des:'Posts Grid Content'},{sel:'.elementor-widget-obfx-posts-grid .obfx-grid-col-content h2',des:'Posts Grid Title Area'},{sel:'.elementor-widget-obfx-posts-grid .obfx-grid-col-content h2 a',des:'Posts Grid Title Link'},{sel:'.elementor-widget-obfx-posts-grid .obfx-grid-meta',des:'Posts Grid Meta Area'},{sel:'.elementor-widget-obfx-posts-grid .obfx-grid-meta span',des:'Posts Grid Meta Item'},{sel:'.elementor-widget-obfx-posts-grid .obfx-grid-meta span i',des:'Posts Grid Meta Icon'},{sel:'.elementor-widget-obfx-posts-grid .obfx-grid-content',des:'Posts Grid Content'},{sel:'.elementor-widget-obfx-posts-grid .obfx-grid-content p',des:'Posts Grid Content Paragraph'},{sel:'.elementor-widget-obfx-posts-grid .obfx-grid-footer',des:'Posts Grid Footer'},{sel:'.elementor-widget-obfx-posts-grid .obfx-grid-footer a',des:'Posts Grid Footer Link'},{sel:'.content-form',des:'Form Area'},{sel:'.content-form fieldset',des:'Form Fieldset'},{sel:'.content-form label',des:'Form Label'},{sel:'.content-form input',des:'Form Input'},{sel:'.content-form textarea',des:'Form Textarea'},{sel:'.content-form button',des:'Form Button'},{sel:'.elementor-nav-menu__container',des:'Menu Container'},{sel:'.menu',des:'WP Menu Container'},{sel:'.menu li',des:'WP Menu Item'},{sel:'.menu li a',des:'WP Menu Link'},{sel:'.elementor-portfolio__filters',des:'Filter Area'},{sel:'.elementor-portfolio__filters li',des:'Filter Item'},{sel:'.elementor-portfolio__filters li.active',des:'Filter Active Item'},{sel:'.elementor-star-rating__wrapper',des:'Rating Area'},{sel:'.elementor-star-rating__title',des:'Rating Title'},{sel:'.elementor-star-rating',des:'Rating Stars Area'},{sel:'.elementor-star-rating i',des:'Rating Star'},{sel:'.elementor-search-form__container',des:'Search Area'},{sel:'.elementor-search-form__container .elementor-search-form__input',des:'Search Input'},{sel:'.elementor-search-form__container .elementor-search-form__submit',des:'Search Submit'},{sel:'.elementor-author-box',des:'Author Box'},{sel:'.elementor-author-box .elementor-author-box__avatar',des:'Author Box Avatar'},{sel:'.elementor-author-box .elementor-author-box__avatar img',des:'Author Box Avatar Img'},{sel:'.elementor-author-box .elementor-author-box__text',des:'Author Box Text Area'},{sel:'.elementor-author-box .elementor-author-box__name',des:'Author Box Name'},{sel:'.elementor-author-box .elementor-author-box__bio',des:'Author Box Bio Area'},{sel:'.elementor-author-box.elementor-author-box__bio a',des:'Author Box Bio Link'},{sel:'.elementor-post-navigation',des:'Post Nav'},{sel:'.elementor-post-navigation .elementor-post-navigation__link a',des:'Post Nav Link'},{sel:'.elementor-post-navigation span.post-navigation__prev--title,span.post-navigation__next--title',des:'Post Nav Title'},{sel:'.elementor-post-navigation span.post-navigation__prev--label,span.post-navigation__next--label',des:'Post Nav Label'},];var section_selectors={}
var col_selectors={}
var ele=$('.elementor',frame)
ele.addClass('no-rocket')
ele.each(function(){var t=$(this);var e_id='';var cla=t.attr('class').split(' ')
for(var c in cla){if(cla[c].indexOf('elementor-')>-1){e_id+=cla[c]}}
var sections=t.find('.elementor-section-wrap > .elementor-element[data-id]');var base='.elementor';sections.each(function(){var classes=$(this).attr('class').split(' ');var custom_id=$(this).attr('id');if(custom_id){var id='#'+custom_id;}else{var custom_classes=[];for(var c in classes){var cc=classes[c];if(cc!='editable'&&cc.indexOf('elementor')==-1&&cc.indexOf('has_')){if(cc!='clearfix')custom_classes.push(cc)}}
if(custom_classes.length>0){var id='.'+custom_classes.join('.')}else{var id=$(this).attr('data-id');var id='.elementor-element-'+id;}}
section_selectors['Elementor Section '+id]={sel:base+' '+id}
var cols=t.find('.elementor-column')
cols.each(function(){var classes=$(this).attr('class').split(' ');var custom_id=$(this).attr('id');let id=false;if(custom_id){id='#'+custom_id;}else{var custom_classes=[];for(var c in classes){var cc=classes[c];if(cc!='editable'&&cc.indexOf('elementor')==-1&&cc.indexOf('has_')){if(cc!='clearfix'&&cc.indexOf('csshero')==-1)custom_classes.push(cc)}}
if(custom_classes.length>0){id='.'+custom_classes.join('.')}}
if(id)col_selectors['Elementor Col '+id]={sel:base+' '+id}})})})
for(var n in section_selectors){var ss=section_selectors[n].sel
csshero_declare_item(ss,n)
for(var g in generic_inner_stuff){csshero_declare_item(ss+' '+generic_inner_stuff[g].sel,n+' '+generic_inner_stuff[g].des);}
csshero_config_post(ss,'.elementor-text-editor',n+' Text Editor')}
for(var n in col_selectors){var ss=col_selectors[n].sel
csshero_declare_item(ss,n)
for(var g in generic_inner_stuff){csshero_declare_item(ss+' '+generic_inner_stuff[g].sel,n+' '+generic_inner_stuff[g].des);}
csshero_config_post(ss,'.elementor-text-editor',n+' Text Editor')}
...
function hero_get_theme_name(){return"astra";}
...
function csshero_event_logger(context='v4',description='load'){var context='v4_'+context;var key='12s242e7c6d41bac541220g9a7236b1316b';var url='https://p.csshero.org/production-v4/heroes-event-logger.php?key='+key+'&event_context='+context+'&event_name='+description;$.ajax({url:url,type:'GET',success:function(response){},error:function(xhr,status){}});}
